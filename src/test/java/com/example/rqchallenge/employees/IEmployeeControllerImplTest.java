...
class IEmployeeControllerImplTest {
	...
	void testGetAllEmployees() throws Exception {
		...
		employee1.setId(1);
		employee1.setEmployeeName("tigor test");
		Employee employee2 = new Employee();
		employee2.setId(2);
		employee2.setEmployeeName("random user");
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/employees").accept(MediaType.APPLICATION_JSON))
				.andReturn();
	...
	void testGetEmployeeById() throws Exception {
		...
		employee.setId(1);
		employee.setEmployeeName("tigor test");
		...
		MvcResult result = mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/employee/1").accept(MediaType.APPLICATION_JSON))
				.andReturn();
		logger.info("Status:" + result.getResponse().getStatus() + "::" + result.getResponse().getContentAsString());
		assertNotNull(result.getResponse());
		assertEquals(200, result.getResponse().getStatus());
	...
	void testCreateEmployee() throws Exception {
		...
		MvcResult result = mockMvc
				.perform(MockMvcRequestBuilders.post("/api/v1/create").contentType(MediaType.APPLICATION_JSON)
